      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 animate-fade-in">
            ...
            {/* Visibility Section - Only for manual/document/text recipes (not URL) */}
              ...
              <Card className="p-4 mb-6 border-stone-100" data-testid="visibility-section">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-medium text-foreground">Partager cette recette</h3>
                      <p className="text-xs text-stone-500">
                        {isPublic 
                          ? "Visible dans le bandeau et copiable par tous" 
